        ...
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#" className="flex items-center gap-3 group relative">
            <div className="relative">
              ...
              <div className="relative w-12 h-12 bg-[#00FFD1] flex flex-col items-center justify-center transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(0,255,209,0.5)]">
